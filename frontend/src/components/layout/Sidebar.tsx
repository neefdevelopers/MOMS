  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col h-full shrink-0 z-30 select-none">
      ...
      <div className="p-4 border-b border-slate-200 flex items-center gap-3">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-blue-700 via-blue-600 to-indigo-600 flex items-center justify-center text-white font-bold shadow-md shadow-blue-500/20">
          <Tv className="w-5 h-5" />
        </div>
        <div className="min-w-0">
          <h1 className="font-extrabold text-base text-slate-900 leading-tight tracking-wider flex items-center gap-1.5">
            MOMS
            <span className="text-[10px] font-mono px-1.5 py-0.5 bg-blue-50 text-blue-700 border border-blue-200 rounded font-bold">
              PRO
            </span>
          </h1>
          <p className="text-[11px] text-slate-500 font-medium truncate">Media Operations Suite</p>
        </div>
      </div>
      ...
      <div className="px-4 py-2.5 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
        ...
        <span
          className={`text-[10px] px-2 py-0.5 rounded-md font-bold uppercase border tracking-wider ${
      ...
      {user && (
        <div className="p-3 border-t border-slate-200 bg-slate-50 flex items-center gap-3">
          <div className="relative">
            ...
            />
            <span className="w-2 h-2 rounded-full bg-emerald-500 absolute bottom-0 right-0 border border-white" />
          </div>

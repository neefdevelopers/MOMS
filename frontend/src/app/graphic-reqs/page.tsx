                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-slate-200">
                            {del.fileUrl ? (
                              <a
                                ...
                                className="px-2.5 py-1 bg-emerald-50 hover:bg-emerald-900 text-emerald-700 border border-emerald-200 rounded font-bold text-[10px] flex items-center gap-1 transition-colors"
                              >
                            ...
                            {canManage && (
                              <div className="flex items-center gap-1.5">
                                ...
                                <button
                                  ...
                                  className="px-2 py-1 bg-rose-50 hover:bg-red-900 text-rose-700 border border-rose-200 rounded font-semibold text-[10px] transition-colors"
                                >
                                  Delete
                                </button>
                              </div>
        ...
        >
          ...
          >
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-slate-700 font-semibold mb-1 text-xs">Deliverable Output Name *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1 text-xs">Upload Deliverable Output File</label>
                <input
                  type="file"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1 text-xs">Remarks / Feedback</label>
                <input
                  type="text"

      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white border border-slate-200 p-6 rounded-xl">
        <div>
          <h1 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <Tag className="w-5 h-5 text-blue-600" /> Brand Directory & Short Codes
          </h1>
        </div>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs backdrop-blur-xs flex items-center justify-center p-4 z-50">
          <form onSubmit={handleSave} className="bg-white border border-slate-200 rounded-xl w-full max-w-md p-6 space-y-4 text-xs">
            ...
            {!editingBrand && (
              <div>
                <label className="text-slate-500 block mb-1 font-semibold">Parent Active Client *</label>
                <select
                  required
                ...
                {activeClients.length === 0 && (
                  <p className="text-[10px] text-amber-600 mt-1">No active clients available! Onboard an active client first.</p>
                )}
              </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-slate-500 block mb-1 font-semibold">Brand Name *</label>
                <input
                  type="text"
                  required
                  value={formData.name}
              ...
              <div>
                <label className="text-slate-500 block mb-1 font-semibold">Short Code (Unique) *</label>
                <input
                  type="text"
                  required
                  maxLength={5}
              ...
              <div>
                <label className="text-slate-500 block mb-1 font-semibold">Industry</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-slate-500 block mb-1 font-semibold">Brand Logo URL</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-slate-500 block mb-1 font-semibold">Primary Theme Color</label>
                <div className="flex items-center gap-2">
                  <input
                    type="color"
            ...
            <div>
              <label className="text-slate-500 block mb-1 font-semibold">Brand Status *</label>
              <select
            ...
            <div>
              <label className="text-slate-500 block mb-1 font-semibold">Description</label>
              <textarea
                rows={2}
